...
public class GeometriesTests {
   ...
   public void testfindIntsersections() {
        ...
        assertEquals("not all intersections found",geometries.findIntsersections(test_ray).size(), 2);
        ...
        assertEquals("only one object is intersected with the Ray", geometries.findIntsersections(test_ray).size(),1);
        ...
        assertEquals("all Geometries objects intersected with the ray", geometries.findIntsersections(test_ray3).size(),3);
